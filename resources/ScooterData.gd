...
## The .glb model for this bike. Leave empty to use the default scooter model.
@export var model_path: String = ""

## Yaw (degrees) to rotate this model so it faces down the road. Tune in 90
## steps if a bike points the wrong way. 270 matches the default scooter.glb.
